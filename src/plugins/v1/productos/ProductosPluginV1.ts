...
import { ProductosServiceV1 } from './ProductosServiceV1';
import { ProductosControllerV1 } from './ProductosControllerV1';
import { createProductosRoutesV1 } from './ProductosRoutesV1';

export class ProductosPluginV1 implements IProductosPlugin {
  public readonly name = 'productos';
  public readonly version = '1.0.0';
  
  private service!: ProductosServiceV1;
  private controller!: ProductosControllerV1;
